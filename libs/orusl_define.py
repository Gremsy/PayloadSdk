...
# ORUSL Payload SDK Definitions
# This file contains definitions specific to ORUSL payload model
...
# EO EIS modes
PAYLOAD_CAMERA_EO_EIS_MODE                  =                           "C_V_EIS"
class payload_camera_eo_eis_mode(IntEnumBase):
    PAYLOAD_CAMERA_EO_EIS_MODE_HOLD         =                           0
    PAYLOAD_CAMERA_EO_EIS_MODE_ON           =                           2
    PAYLOAD_CAMERA_EO_EIS_MODE_OFF          =                           3

# EO EIS levels
PAYLOAD_CAMERA_EO_EIS_LEVEL                 =                           "C_V_EIS_LV"
class payload_camera_eo_eis_level(IntEnumBase):
    PAYLOAD_CAMERA_EO_EIS_LEVEL_SUPER       =                           2
    # Note: PAYLOAD_CAMERA_EO_EIS_LEVEL_SUPER_PLUS value missing in C++ header

# EO Spot Light Avoidance
PAYLOAD_CAMERA_EO_SPOT_LIGHT_AVOIDANCE      =                           "C_V_SPAVOID"
class payload_camera_eo_spot_light_avoidance(IntEnumBase):
    PAYLOAD_CAMERA_EO_SPOT_LIGHT_AVOIDANCE_ON   =                       2
    PAYLOAD_CAMERA_EO_SPOT_LIGHT_AVOIDANCE_OFF  =                       3

# EO Flicker Reduction
PAYLOAD_CAMERA_EO_FLICKER_REDUCTION         =                           "C_V_FLREDUCT"
class payload_camera_eo_flicker_reduction(IntEnumBase):
    PAYLOAD_CAMERA_EO_FLICKER_REDUCTION_ON  =                           2
    PAYLOAD_CAMERA_EO_FLICKER_REDUCTION_OFF =                           3

# EO Noise Reduction
PAYLOAD_CAMERA_EO_NOISE_REDUCTION           =                           "C_V_NSREDUCT"
class payload_camera_eo_noise_reduction(IntEnumBase):
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_OFF   =                           0
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_LV1   =                           1
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_LV2   =                           2
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_LV3   =                           3
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_LV4   =                           4
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_LV5   =                           5
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_MANUAL =                          127

# EO 2D noise reduction, in case of PAYLOAD_CAMERA_EO_NOISE_REDUCTION = PAYLOAD_CAMERA_EO_NOISE_REDUCTION_MANUAL
PAYLOAD_CAMERA_EO_NOISE_REDUCTION_2D        =                           "C_V_NSREDUCT2D"
class payload_camera_eo_noise_reduction_2d(IntEnumBase):
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_2D_OFF =                          0
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_2D_LV1 =                          1
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_2D_LV2 =                          2
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_2D_LV3 =                          3
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_2D_LV4 =                          4
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_2D_LV5 =                          5

# EO 3D noise reduction, in case of PAYLOAD_CAMERA_EO_NOISE_REDUCTION = PAYLOAD_CAMERA_EO_NOISE_REDUCTION_MANUAL
PAYLOAD_CAMERA_EO_NOISE_REDUCTION_3D        =                           "C_V_NSREDUCT3D"
class payload_camera_eo_noise_reduction_3d(IntEnumBase):
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_3D_OFF =                          0
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_3D_LV1 =                          1
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_3D_LV2 =                          2
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_3D_LV3 =                          3
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_3D_LV4 =                          4
    PAYLOAD_CAMERA_EO_NOISE_REDUCTION_3D_LV5 =                          5

# EO stable zoom
PAYLOAD_CAMERA_EO_STABLE_ZOOM               =                           "C_V_STZOOM"
class payload_camera_eo_stable_zoom(IntEnumBase):
    PAYLOAD_CAMERA_EO_STABLE_ZOOM_OFF       =                           0
    PAYLOAD_CAMERA_EO_STABLE_ZOOM_ON        =                           1

# Payload defog fan - UNIQUE TO ORUSL!
# This is the key feature that differentiates ORUSL from other payload models
