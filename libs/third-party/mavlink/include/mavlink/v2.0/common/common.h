...
// MESSAGE DEFINITIONS
#include "../ardupilotmega/mavlink_msg_digicam_configure.h"
#include "../ardupilotmega/mavlink_msg_mount_status.h"
#include "../ardupilotmega/mavlink_msg_ahrs2.h"
