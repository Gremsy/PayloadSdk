	...
	case STATE_MOVEMENT_0:
		{
			...
			if (isCamAvai) {
				...
				usleep(100000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_ZOOM_FACTOR, ZOOM_IR_12X, PARAM_TYPE_UINT32);
				usleep(2000000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_PALETTE, PAYLOAD_CAMERA_IR_PALETTE_6, PARAM_TYPE_UINT32);
				usleep(100000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_ZOOM_FACTOR, ZOOM_IR_20X, PARAM_TYPE_UINT32);
				usleep(2000000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_PALETTE, PAYLOAD_CAMERA_IR_PALETTE_7, PARAM_TYPE_UINT32);
				usleep(100000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_ZOOM_FACTOR, ZOOM_IR_28X, PARAM_TYPE_UINT32);
				usleep(2000000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_PALETTE, PAYLOAD_CAMERA_IR_PALETTE_8, PARAM_TYPE_UINT32);
				usleep(100000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_ZOOM_FACTOR, ZOOM_IR_36X, PARAM_TYPE_UINT32);
				usleep(2000000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_PALETTE, PAYLOAD_CAMERA_IR_PALETTE_9, PARAM_TYPE_UINT32);
				usleep(100000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_ZOOM_FACTOR, ZOOM_IR_44X, PARAM_TYPE_UINT32);
				usleep(2000000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_PALETTE, PAYLOAD_CAMERA_IR_PALETTE_10, PARAM_TYPE_UINT32);
				usleep(100000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_ZOOM_FACTOR, ZOOM_IR_48X, PARAM_TYPE_UINT32);
				usleep(2000000);
				my_payload->setPayloadCameraParam(PAYLOAD_CAMERA_IR_PALETTE, PAYLOAD_CAMERA_IR_PALETTE_3, PARAM_TYPE_UINT32);
				usleep(100000);
